...
class Encoder_Decoder(nn.Module):
    ...
    def forward(self,x,y):
        ...
        out_y1=self.res1(self.conv1(out_y1))

        out_1=torch.cat((out_x1,out_y1),1)
        out_1= torch.cat((out_1,out_a1),1)
        ...
        out_y1=self.res2(self.conv2(out_y1))
        ...
        out_y1=self.res3(self.conv3(out_y1))
